        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('utilisateurs.index') }}">
                        Utilisateurs
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Caisse::class)
                        <x-dropdown-link href="{{ route('caisses.index') }}">
                        Caisses
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\ModePaiement::class)
                        <x-dropdown-link href="{{ route('mode-paiements.index') }}">
                        Mode Paiements
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Frequence::class)
                        <x-dropdown-link href="{{ route('frequences.index') }}">
                        Frequences
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\StructureFinanciere::class)
                        <x-dropdown-link href="{{ route('structure-financieres.index') }}">
                        Structure Financieres
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\TypeCaisse::class)
                        <x-dropdown-link href="{{ route('type-caisses.index') }}">
                        Type Caisses
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Caisse::class)
                <x-responsive-nav-link href="{{ route('caisses.index') }}">
                Caisses
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\ModePaiement::class)
                <x-responsive-nav-link href="{{ route('mode-paiements.index') }}">
                Mode Paiements
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Transaction::class)
                ...
                @endcan
                @can('view-any', App\Models\Frequence::class)
                <x-responsive-nav-link href="{{ route('frequences.index') }}">
                Frequences
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\StructureFinanciere::class)
                <x-responsive-nav-link href="{{ route('structure-financieres.index') }}">
                Structure Financieres
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\TypeCaisse::class)
                <x-responsive-nav-link href="{{ route('type-caisses.index') }}">
                Type Caisses
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Commune::class)
                ...
                @endcan
                @can('view-any', App\Models\Departement::class)
                <x-responsive-nav-link href="{{ route('departements.index') }}">
                Departements
                </x-responsive-nav-link>
                @endcan
