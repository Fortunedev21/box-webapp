<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.mode_paiements.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $modePaiement)
                                        <a
                                            href="{{ route('mode-paiements.edit', $modePaiement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $modePaiement)
                                        <a
                                            href="{{ route('mode-paiements.show', $modePaiement) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $modePaiement)
                                        <form
                                            action="{{ route('mode-paiements.destroy', $modePaiement) }}"
                                            method="POST"
