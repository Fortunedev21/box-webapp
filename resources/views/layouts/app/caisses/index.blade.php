                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $caisse)
                                        <a
                                            href="{{ route('caisses.edit', $caisse) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $caisse)
                                        <a
                                            href="{{ route('caisses.show', $caisse) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
